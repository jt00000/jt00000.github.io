...
- exploitはこちら：https://github.com/jt00000/ctf.writeup/blob/master/pbctf2020/pwnception/dist/challenge/solve.py
...
- kernel: こちらは単体では起動できなくなっています。mainを経由した接続によって、userlandにおけるシステムコールに反応して処理する機能があります。
